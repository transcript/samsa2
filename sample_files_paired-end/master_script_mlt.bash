#!/bin/bash
#SBATCH -D /path/to/sample_files_directory
#SBATCH -o /path/to/slurm-out/stdout-%j.txt
#SBATCH -e /path/to/std-error/mich-stderr-%j.txt
#SBATCH -J job_name
#SBATCH -t 10:00:00
...
starting_location=/path/to/sample_files_directory

#	1. PEAR
pear_location=/path/to/programs/pear

# 	2. Trimmomatic
trimmomatic_location=/path/to/trimmomatic-0.33.jar

#	3. SortMeRNA
sortmerna_location=/path/to/programs/sortmerna-2.1_directory

#	4. DIAMOND
diamond_database="/path/to/diamond_indexed_database" #do not include extension
diamond_subsys_db="/path/to/diamond_indexed_subsys_db" #do not include extension
diamond_location="/path/to/programs/diamond"

#	5. Aggregation
python_programs=/path/to/python_scripts_directory
RefSeq_db="/path/to/diamond_indexed_database"
Subsys_db="path/to/diamond_indexed_subsys_db"

#	6. R scripts and paths
export R_LIBS="/path/to/R_LIBS_directory"
R_programs=/path/to/R_scripts_directory
...
do
	...
	$pear_location -f $file1 -r $file2 -o $out_name
done

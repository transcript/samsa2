...
option_list = list(
  ...
  make_option(c("-O", "--out"), type="character", default="raw_counts_table.tab", 
...
write.table(complete_table, file = save_filename, append = FALSE, quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)

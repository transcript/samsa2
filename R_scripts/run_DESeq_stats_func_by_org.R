...
setwd(wd_location)
# or
setwd("~/Desktop/Projects/Lab Stuff/Macaque project/func_output/individual_org_functions/B_caccae/")
...
write.table(sorted_org_results, file = "DESeq_macaque_mucin_degrader_functions.tsv", 
